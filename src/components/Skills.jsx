  ...
  return (
    <div className="bg-gradient border-y border-neutral-800 w-full relative h-36 xs:h-40 sm:h-44 lg:h-52">
      ...
      <div className="skills-container">
        <svg
          className="color-java skill-icon tooltip h-14"
        ...
        <svg
          className="color-js skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 448 512"
        >
        ...
        <svg
          className="color-html skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 384 512"
        >
        ...
        <svg
          className="color-react skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 512 512"
        >
        ...
        <svg
          className="color-unity skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 448 512"
        >
        ...
        <svg
          className="color-python skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 448 512"
        >
        ...
        <svg
          className="color-c skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 384 512"
        >
        ...
        <svg
          className="color-sharp skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 448 512"
        >
        ...
        <svg
          className="color-sql skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 448 512"
        >
        ...
        <svg
          className="color-php skill-icon tooltip"
          xmlns="http://www.w3.org/2000/svg"
          height="1em"
          viewBox="0 0 640 512"
        >

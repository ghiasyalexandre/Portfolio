    ...
    skills.forEach((skill, index) => {
      if (skill === "js") {
        results.push(
          <svg
            key={index}
            className="color-js skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip"
          ...
          >
            ...
            <title className="tooltiptext">Javascript</title>
          </svg>
        );
      } else if (skill === "java") {
        results.push(
          <svg
            key={index}
            className="color-java skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
          >
            ...
            <title className="tooltiptext">Java</title>
          </svg>
        );
      } else if (skill === "sharp") {
        results.push(
          <svg
            key={index}
            className="color-sharp skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
            <path d="M181.3 32.4c17.4 2.9 29.2 19.4 26.3 36.8L197.8 128h95.1l11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3s29.2 19.4 26.3 36.8L357.8 128H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H347.1L325.8 320H384c17.7 0 32 14.3 32 32s-14.3 32-32 32H315.1l-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8l9.8-58.7H155.1l-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8L90.2 384H32c-17.7 0-32-14.3-32-32s14.3-32 32-32h68.9l21.3-128H64c-17.7 0-32-14.3-32-32s14.3-32 32-32h68.9l11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3zM187.1 192L165.8 320h95.1l21.3-128H187.1z" />
            <title className="tooltiptext">C#</title>
          </svg>
        );
      } else if (skill === "c") {
        results.push(
          <svg
            key={index}
            className="color-c skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-php skill-icon-card-footer h-6 xs:h-7 sm:h-8 md:h-9 xl:h-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512"
          >
            ...
            <title className="tooltiptext">PHP</title>
          </svg>
        );
      } else if (skill === "sql") {
        results.push(
          <svg
            key={index}
            className="color-sql skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
            <path d="M448 80v48c0 44.2-100.3 80-224 80S0 172.2 0 128V80C0 35.8 100.3 0 224 0S448 35.8 448 80zM393.2 214.7c20.8-7.4 39.9-16.9 54.8-28.6V288c0 44.2-100.3 80-224 80S0 332.2 0 288V186.1c14.9 11.8 34 21.2 54.8 28.6C99.7 230.7 159.5 240 224 240s124.3-9.3 169.2-25.3zM0 346.1c14.9 11.8 34 21.2 54.8 28.6C99.7 390.7 159.5 400 224 400s124.3-9.3 169.2-25.3c20.8-7.4 39.9-16.9 54.8-28.6V432c0 44.2-100.3 80-224 80S0 476.2 0 432V346.1z" />
            <title className="tooltiptext">SQL</title>
          </svg>
        );
      } else if (skill === "react") {
        results.push(
          <svg
            key={index}
            className="color-js skill-icon-card-footer h-6 xs:h-7 sm:h-8 md:h-9 xl:h-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
            ...
            <title className="tooltiptext">React</title>
          </svg>
        );
        ...
        results.push(
          <svg
            key={index}
            className="color-js skill-icon-card-footer w-7 xs:w-8 sm:w-9 md:w-10 xl:w-11 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
            ...
            <title className="tooltiptext">Angular</title>
          </svg>
        );
      } else if (skill === "ts") {
        results.push(
          ...
          >
            ...
            <title className="tooltiptext">Typescript</title>
          </svg>
        );
      } else if (skill === "unity") {
        results.push(
          <svg
            key={index}
            className="color-unity skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
            ...
            <title className="tooltiptext">Unity</title>
          </svg>
        );
      } else if (skill === "html") {
        results.push(
          <svg
            key={index}
            className="color-html skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
          >
            <path d="M0 32l34.9 395.8L191.5 480l157.6-52.2L384 32H0zm308.2 127.9H124.4l4.1 49.4h175.6l-13.6 148.4-97.9 27v.3h-1.1l-98.7-27.3-6-75.8h47.7L138 320l53.5 14.5 53.7-14.5 6-62.2H84.3L71.5 112.2h241.1l-4.4 47.7z" />
            <title className="tooltiptext">HTML</title>
          </svg>
        );
      } else if (skill === "vr") {
        results.push(
          <svg
            key={index}
            className="color-html skill-icon-card-footer h-6 xs:h-7 sm:h-8 md:h-9 xl:h-10 tooltip"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512"
          >
            ...
            <title className="tooltiptext">VR</title>
          </svg>
        );
      } else if (skill === "css") {
        results.push(
          ...
          >
            ...
            <title className="tooltiptext">CSS</title>
          </svg>
        );
      }
    });

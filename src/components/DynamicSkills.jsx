...
function DynamicSkills(props) {
    ...
    skills.forEach((skill, index) => {
      if (skill === "js") {
        results.push(
          <svg
            key={index}
            className="color-js skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
        ...
        results.push(
          <svg
            key={index}
            className="color-java skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-sharp skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-c skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-php skill-icon-card-footer h-6 xs:h-7 sm:h-8 md:h-9 xl:h-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-sql skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-js skill-icon-card-footer h-6 xs:h-7 sm:h-8 md:h-9 xl:h-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-js skill-icon-card-footer w-7 xs:w-8 sm:w-9 md:w-10 xl:w-11 tooltip hover:scale-115 transition-transform ease-in-out duration-300 "
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-unity skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          >
        ...
        results.push(
          <svg
            key={index}
            className="color-html skill-icon-card-footer w-6 xs:w-7 sm:w-8 md:w-9 xl:w-10 tooltip hover:scale-115 transition-transform ease-in-out duration-300"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
          >
  ...
  return <div className="card-skills">{results}</div>;
}

  ...
  return (
    ...
    >
      <a
        ...
        draggable={false}
        aria-label="Visit Ghiasy Alexandre's GitHub profile"
      >
        Github
        <svg
      ...
      <a
        ...
        rel="noopener noreferrer"
        draggable={false}
        aria-label="Visit Ghiasy Alexandre's LinkedIn profile"
      >
        LinkedIn
        <svg
      ...
      <a
        ...
        rel="noopener noreferrer"
        draggable={false}
        aria-label="Download Ghiasy Alexandre's Resume"
      >
        Resume
        <svg
          id="core"

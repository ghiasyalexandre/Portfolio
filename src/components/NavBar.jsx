...
function NavBar() {
  ...
  return (
    <nav
      ...
      className="nav fun nav-border "
    >
      <Link to="/" draggable={false} aria-label="Home">
        <svg
          className="icon tooltip h-8 ml-2"
        ...
        >
          ...
          <title id="react-title" className="tooltiptext">
            Made with React
          </title>
        </svg>
      </Link>
      ...
      >
        <svg
          ...
          width="16"
          viewBox="0 0 384 512"
          aria-labelledby="scroll-top-title"
        >
          <title id="scroll-top-title" className="tooltiptext">
            Scroll To Top
          </title>
